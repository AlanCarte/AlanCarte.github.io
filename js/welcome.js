...
$.ajax({
    ...
    data: {
        key: 'KDLBZ-WQX6I-IEGGH-UV3O4-RZCG7-3EFM4',
        output: 'jsonp',
    },
    dataType: 'jsonp',
...
function showWelcome() {
    ...
    let dist = getDistance(116.2056, 40.345, ipLocation.result.location.lng, ipLocation.result.location.lat); //这里记得换成自己的经纬度
